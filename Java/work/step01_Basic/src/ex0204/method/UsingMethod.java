...
class UsingMethodExam{
	...
	(구현부에서)하는 일 : 
		...
		인수로 받은 String 에 바보를 붙여서 리턴 // this 사용해라
	*/	
	public String methodExam03_02(String str, int i) {
		System.out.println("methodExam03_02가 호출되었습니다.");
		String str1 = str + "바보";
		System.out.println(str1);
		int a = this.methodExam03_01(i);
		System.out.println("methodExam03_01의 리턴 값: " + a);
	...
	*/	
	protected double methodExam03_04(int i, double j, int k) {
		...
		double re = m2.methodExam02_04(i, j, k);
...
class UsingMethod{
	...
	//메인메소드에서
		//UsingMethodExam의 호출가능한 메소드들을 호출하고 // private은 호출불가
		// 리턴하는 값 있다면 출력
	UsingMethodExam ume = new UsingMethodExam();
	String s1 = ume.methodExam03_02("이예진", 9);
	ume.methodExam03_03(42, "이예진");
	double re = ume.methodExam03_04(8, 5.6, 7);
