...
class SubClass extends SuperClass{//SubClass is a SuperClass 관계 성립
	...
	public void methodZero(){//public void methodZero()
		
		System.out.println("SubClass객체의 methodZero()메소드가 호출되었습니다.");
		System.out.println("intNumber="+intNumber+"\t"+"memberString="+memberString);
	}
 	
	protected void methodOwn(){//protected void methodOwn()
	...
	int methodTwo(int a){//int methodTwo(int i)
	...
	protected String methodThree(int k,String str){//protected String methodThree(int i, String s)
	...
	public void methodFour(){//public void methodFour()
